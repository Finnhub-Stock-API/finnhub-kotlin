...
try {
    ...
    println("5xx response calling DefaultApi#mutualFundProfile")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling DefaultApi#mutualFundSectorExposure")
    e.printStackTrace()
}
```
...
val limit : kotlin.Long = 789 // kotlin.Long | Limit number of results. Leave empty to get the full list.
try {
    val result : Ownership = apiInstance.ownership(symbol, limit)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling DefaultApi#ownership")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DefaultApi#ownership")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling DefaultApi#pressReleases")
    e.printStackTrace()
}
```
...
val apiInstance = DefaultApi()
val symbol : kotlin.String = symbol_example // kotlin.String | Symbol of the company: AAPL.
val date : kotlin.String = date_example // kotlin.String | Get data on a specific date in the past. The data is available weekly so your date will be automatically adjusted to the last day of that week.
try {
    val result : PriceMetrics = apiInstance.priceMetrics(symbol, date)
    println(result)
} catch (e: ClientException) {
...
------------- | ------------- | ------------- | -------------
 **symbol** | **kotlin.String**| Symbol of the company: AAPL. |
 **date** | **kotlin.String**| Get data on a specific date in the past. The data is available weekly so your date will be automatically adjusted to the last day of that week. | [optional]
...
val cik : kotlin.String = cik_example // kotlin.String | CIK.
try {
    val result : RevenueBreakdown = apiInstance.revenueBreakdown(symbol, cik)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling DefaultApi#revenueBreakdown")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DefaultApi#revenueBreakdown")
    e.printStackTrace()
}
```
...
val apiInstance = DefaultApi()
val region : kotlin.String = region_example // kotlin.String | Region. A list of supported values for this field can be found <a href=\"https://docs.google.com/spreadsheets/d/1afedyv7yWJ-z7pMjaAZK-f6ENY3mI3EBCk95QffpoHw/edit?usp=sharing\" target=\"_blank\">here</a>.
try {
    val result : SectorMetric = apiInstance.sectorMetric(region)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling DefaultApi#sectorMetric")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DefaultApi#sectorMetric")
    e.printStackTrace()
}
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **region** | **kotlin.String**| Region. A list of supported values for this field can be found &lt;a href&#x3D;\&quot;https://docs.google.com/spreadsheets/d/1afedyv7yWJ-z7pMjaAZK-f6ENY3mI3EBCk95QffpoHw/edit?usp&#x3D;sharing\&quot; target&#x3D;\&quot;_blank\&quot;&gt;here&lt;/a&gt;. |
...
val to : kotlin.String = 2013-10-20 // kotlin.String | To date <code>YYYY-MM-DD</code>.
try {
    val result : SocialSentiment = apiInstance.socialSentiment(symbol, from, to)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling DefaultApi#socialSentiment")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DefaultApi#socialSentiment")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling DefaultApi#stockBasicDividends")
    e.printStackTrace()
}
```
...
val to : kotlin.String = 2013-10-20 // kotlin.String | To date <code>YYYY-MM-DD</code>.
try {
    val result : LobbyingResult = apiInstance.stockLobbying(symbol, from, to)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling DefaultApi#stockLobbying")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DefaultApi#stockLobbying")
    e.printStackTrace()
}
```
...
val skip : kotlin.Long = 789 // kotlin.Long | Number of ticks to skip. Use this parameter to loop through the entire data.
try {
    val result : HistoricalNBBO = apiInstance.stockNbbo(symbol, date, limit, skip)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling DefaultApi#stockNbbo")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DefaultApi#stockNbbo")
    e.printStackTrace()
}
```
...
val apiInstance = DefaultApi()
val exchange : kotlin.String = exchange_example // kotlin.String | Exchange you want to get the list of symbols from. List of exchange codes can be found <a href=\"https://docs.google.com/spreadsheets/d/1I3pBxjfXB056-g_JYf_6o3Rns3BV2kMGG1nCatb91ls/edit?usp=sharing\" target=\"_blank\">here</a>.
val mic : kotlin.String = mic_example // kotlin.String | Filter by MIC code.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **exchange** | **kotlin.String**| Exchange you want to get the list of symbols from. List of exchange codes can be found &lt;a href&#x3D;\&quot;https://docs.google.com/spreadsheets/d/1I3pBxjfXB056-g_JYf_6o3Rns3BV2kMGG1nCatb91ls/edit?usp&#x3D;sharing\&quot; target&#x3D;\&quot;_blank\&quot;&gt;here&lt;/a&gt;. |
 **mic** | **kotlin.String**| Filter by MIC code. | [optional]
 **securityType** | **kotlin.String**| Filter by security type used by OpenFigi standard. | [optional]
 **currency** | **kotlin.String**| Filter by currency. | [optional]
...
val to : kotlin.String = 2013-10-20 // kotlin.String | To date <code>YYYY-MM-DD</code>.
try {
    val result : UsptoPatentResult = apiInstance.stockUsptoPatent(symbol, from, to)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling DefaultApi#stockUsptoPatent")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DefaultApi#stockUsptoPatent")
    e.printStackTrace()
}
```
...
val symbol : kotlin.String = symbol_example // kotlin.String | Symbol.
try {
    val result : SupplyChainRelationships = apiInstance.supplyChainRelationships(symbol)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling DefaultApi#supplyChainRelationships")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DefaultApi#supplyChainRelationships")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling DefaultApi#symbolSearch")
    e.printStackTrace()
}
```
